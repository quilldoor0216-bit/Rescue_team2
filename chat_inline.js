        ...
        // Helper to clear persisted app state on each login (mirrors main app)
                    ...
                    if (att.type === 'image') {
                        ...
                        fileWrap.innerHTML = `
                            ...
                            <div style="flex:1; min-width:0;">
                                ...
                                <div style="font-size:10px; color:#94a3b8;">${formatFileSize(att.size)}</div>
                            </div>
        ...
        function calculateMessageDelay(text) {
            ...
            return Math.min(2200, Math.max(650, calculated));
        }
        ...
        if (chatInput) {
            chatInput.addEventListener('keydown', (e) => {
                ...
                const targetLine = getNextScriptLine();
                if (!targetLine) return; // Finished script -> normal typing
